		...
		<div class="predict">
			...
			{#if predictMode === 'duration'}
				<div class="predrow">
					...
					<div class="predinput">
						<input id="cp-duration" type="number" min="2" max="120" step="1" bind:value={durationMin} />
			...
			{:else}
				<div class="predrow">
					...
					<div class="predinput">
						<input id="cp-distance" type="number" min="100" max="50000" step="100" bind:value={distanceM} />
