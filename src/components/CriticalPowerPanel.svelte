...
{#if cp}
	<div class="du-card cpcard">
		...
		<div class="cpstats">
			...
			{/if}
			<div class="cs">
				<div class="csv"><span class="du-badge du-badge-secondary">{cp.method === 'model' ? t('dashboard.formModelled') : t('dashboard.formEstimated')}</span></div>
