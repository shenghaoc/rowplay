  ...
  return args.map((a) => {
    ...
    if (typeof a === "object" && a !== null) {
      try {
        ...
        // Unserializable (circular, BigInt, …). Default stringification would
        // only yield "[object Object]"; drop the value rather than risk leaking
        // anything through a custom toString().
        return REDACTED;
      }
    }
    return a;
