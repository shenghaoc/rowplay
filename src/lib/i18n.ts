...
const en = {
	...
	compare: {
		...
		lead: 'Side-by-side analysis of two pieces — overlay pace, power and heart rate against distance and see where you gained or lost.',
		workoutA: 'Workout A',
		workoutB: 'Workout B',
		choose: 'Choose a workout…',
		run: 'Compare',
		swap: 'Swap A ↔ B',
		pickTwo: 'Choose two workouts above, or pick one from the list and tap Compare on a second.',
		alignedNote: 'Charts aligned to {distance} covered (shorter piece sets the scale).',
		vsDistance: 'vs distance',
		deltaTable: 'Head-to-head stats',
		deltaHint: 'Delta shows A minus B. Green on time/pace means A was faster or more even.',
		statMetric: 'Metric',
		statDelta: 'Δ (A − B)',
		statTime: 'Time',
		statPace: 'Avg pace',
		...
		winnerA: 'Workout A was faster',
		winnerB: 'Workout B was faster',
		tie: 'Too close to call',
		verdictTimeA: 'A was {seconds}s quicker over the distance',
		verdictTimeB: 'B was {seconds}s quicker over the distance',
		verdictPaceA: 'A averaged {delta} faster',
		verdictPaceB: 'B averaged {delta} faster',
...
const zh = {
	...
	compare: {
		title: '训练对比',
		back: '返回仪表板',
		lead: '两场训练的并排分析——按距离对齐配速、功率与心率，看清哪里更快、哪里更稳。',
		workoutA: '训练 A',
		workoutB: '训练 B',
		choose: '选择训练…',
		run: '开始对比',
		swap: '交换 A ↔ B',
		pickTwo: '在上方选择两场训练，或在列表中先选一场再点另一场的「对比」。',
		alignedNote: '图表按已划过的 {distance} 对齐（以较短的一场为尺度）。',
		vsDistance: '对距离',
		deltaTable: '逐项对比',
		deltaHint: '差值为 A 减 B。时间/配速为绿色表示 A 更快或更稳。',
		statMetric: '指标',
		statDelta: 'Δ（A − B）',
		statTime: '时间',
		statPace: '平均配速',
		...
		winnerB: '训练 B 更快',
		tie: '难分高下',
		verdictTimeA: 'A 在该距离上快 {seconds} 秒',
		verdictTimeB: 'B 在该距离上快 {seconds} 秒',
		verdictPaceA: 'A 平均配速快 {delta}',
		verdictPaceB: 'B 平均配速快 {delta}',
