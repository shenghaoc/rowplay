...
La vue 2D continue de dessiner une figure athlétique procédurale légère. La vue 3D peut charger un paquet compact de géométrie low-poly de l'athlète et de l'équipement, propriété du dépôt et créé spécialement pour rowplay, puis adapter ces formes conçues au même rig piloté par les contacts. Le mouvement et le timing restent des illustrations déterministes issues des cycles enregistrés, et les mains et les pieds restent alignés avec l'équipement. Si l'asset local ne se charge pas, la figure 3D procédurale reste disponible et la 2D demeure le fallback externe stable. La figure est générique : l'asset ne contient ni scan, ni sortie de générateur d'avatar, ni image utilisateur, ni ressemblance avec l'athlète.
