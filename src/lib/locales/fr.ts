...
L'animation suit les cycles valides enregistrés de la séance : chaque ligne de coup fait avancer un coup d'aviron, un cycle de bâtons ou un tour de pédale chorégraphié, tandis que les ancres d'intervalle sans progression de temps ni de distance sont ignorées. La cinématique visible est une illustration déterministe, pas une biomécanique mesurée : Concept2 ne fournit ni courbe de force, ni trajet de poignée, ni longueur de poussée, ni position articulaire, ni posture, et rowplay déduit les watts de l'allure. RowErg enchaîne jambes, tronc puis bras et inverse l'ordre au retour ; SkiErg sépare l'extension, la plantation/traction et la récupération ; BikeErg sépare les manivelles guidées par la cadence du roulement guidé par la distance. Les vues 2D et 3D utilisent des surfaces d'eau, de neige et de piste propres au sport. En 3D, mains et pieds restent sur les cibles de l'équipement, et une caméra de poursuite plus proche et adaptée au sport lisse sa position comme son point de visée.

La vue 2D continue de dessiner une figure athlétique procédurale légère. En 3D, rowplay charge un athlète générique et compact, propriété du dépôt, sous la forme d'un unique maillage skinné. RowErg, SkiErg et BikeErg disposent chacun d'un clip technique canonique créé à la main, échantillonné de façon déterministe à partir de la pose et du temps du replay ; une correction analytique des mains et des pieds préserve ensuite les contacts de référence avec l'équipement. Si V4 ne se charge pas, la géométrie conçue V3 et le rendu 3D procédural restent disponibles, avec Canvas 2D comme fallback externe stable. La figure et les clips sont une présentation générique, pas la biomécanique propre à l'athlète : les assets ne contiennent ni scan, ni sortie de générateur d'avatar, ni image utilisateur, ni mouvement enregistré, ni ressemblance avec l'athlète.

La présentation 3D du RowErg utilise un skiff monoplace d'environ 7,8 m, avançant étrave en tête et doté d'un cockpit ouvert. L'athlète fait face à la poupe, les pieds maintenus par des sangles et attaches de talon visibles sur un cale-pieds fixe à 42° côté étrave ; les dames de nage fixes guident les deux poignées de la prise jusqu'au bas de la poitrine.
...
Toujours bloqué ? La [FAQ](/docs/faq) couvre d'autres cas, et chaque page de ce guide est accessible via **Aide** dans l'en-tête.`,
  ...
  replay: {
    ...
    moments: {
      ...
      bpm: "bpm",
      "best-sustained": "Meilleur effort soutenu",
      "slower-patch": "Passage plus lent",
      "efficient-rhythm": "Rythme le plus efficace",
      "finish-trend": "Tendance finale",
      "best-rep": "Meilleure répétition",
      "slowest-rep": "Répétition la plus lente",
      reasonBestSustained: "{delta}% plus rapide que la référence du jour.",
      reasonSlowerPatch:
        "{delta}% en dessous de la référence du jour ; vérifiez le rythme et la récupération.",
      reasonEfficientRhythm: "Bon rythme sans cadence maximale.",
      reasonFinishStronger: "Le dernier tiers était {delta}% plus rapide que le premier.",
      reasonFinishFade: "Le dernier tiers a perdu {delta}% par rapport au premier.",
      reasonFinishSteady: "Le dernier tiers est resté dans {delta}% du premier.",
      reasonBestRep: "La répétition {rep} était {delta}s/500m plus rapide que la moyenne du set.",
      reasonSlowestRep: "La répétition {rep} était {delta}s/500m plus lente que la moyenne du set.",
    },
    ...
    view2dError: "Erreur du moteur 2D — recharger la page peut aider",
    seekSlider: "Rechercher",
    playbackSpeed: "Vitesse de lecture",
    pacePer500m: "Allure par 500 m",
    uploadCsvHint: "Téléverser un fichier CSV, TCX ou FIT",
    closePanel: "Fermer",
    quality: "Qualité",
    qualityLow: "Basse",
