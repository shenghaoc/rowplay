...
Les deux vues dessinent une figure athlétique procédurale légère au lieu de télécharger ou de scanner un avatar. Les segments supérieurs et inférieurs des bras et des jambes conservent des proportions fixes et s'articulent aux coudes et aux genoux ; le torse et le bassin modelés, les articulations, la tenue et le contraste entre les côtés proche et éloigné gardent chaque posture lisible à l'échelle du replay. Les mains et les pieds restent alignés avec l'équipement correspondant tout au long du cycle. Cette figure est une illustration générique : elle ne reproduit ni le corps, ni les vêtements, ni l'apparence de l'athlète.
