...
Beide Ansichten zeichnen eine leichtgewichtige prozedurale Athletenfigur, statt einen Avatar herunterzuladen oder zu scannen. Ober- und Unterarme sowie Ober- und Unterschenkel behalten feste Proportionen und beugen sich an klaren Ellbogen und Knien; geformter Rumpf und Hüfte, Gelenke, Sportkleidung sowie der Kontrast zwischen naher und ferner Körperseite halten jede Pose in Replay-Größe lesbar. Hände und Füße bleiben während des ganzen Zyklus an der jeweiligen Ausrüstung ausgerichtet. Die Figur ist eine allgemeine Illustration und bildet weder Körper, Kleidung noch Aussehen des Athleten nach.
