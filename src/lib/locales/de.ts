...
Die 2D-Ansicht zeichnet weiterhin eine leichtgewichtige prozedurale Athletenfigur. Die 3D-Ansicht kann ein kompaktes, Repository-eigenes Low-Poly-Paket mit Athleten- und Sportgerätegeometrie laden, das speziell für rowplay erstellt wurde, und diese gestalteten Hüllen auf dasselbe kontaktgesteuerte Rig setzen. Bewegung und Timing bleiben deterministische Illustrationen aus den aufgezeichneten Zyklen, und Hände und Füße bleiben an der Ausrüstung ausgerichtet. Kann das lokale Asset nicht geladen werden, bleibt die prozedurale 3D-Figur verfügbar und 2D der stabile äußere Fallback. Die Figur ist allgemein: Das Asset enthält weder Scan noch Ausgabe eines Avatar-Generators, Nutzerbild oder Ähnlichkeit mit dem Athleten.
