export const de = {
	...
	dashboard: {
		...
		cpExplainEstimate:
			'{scope} estimate: CP wird aus deiner besten längeren Belastung auf {cp} W geschätzt. Logge mehr maximale Belastungen über kurze, mittlere und lange Dauern, um CP/W′ anzupassen.',
		...
		cpConfidence: { high: 'High', medium: 'Medium', low: 'Low', insufficient: 'Insufficient' },
	...
	share: {
		...
		privacyBlocked: 'Dieses Workout ist auf Concept2 nicht öffentlich und kann nicht geteilt werden. Setze seine Privatsphäre im Logbuch zuerst auf „Everyone“.',
