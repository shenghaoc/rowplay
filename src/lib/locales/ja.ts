...
3D の RowErg 表現では、艇首を進行方向に向けた全長約 7.8 m のオープンコックピット・シングルスカルを使用します。選手は艇尾を向き、目に見えるストラップとヒール拘束で、艇首側に固定された 42° のストレッチャーへ足を固定します。固定オールロックにより、左右のハンドルはキャッチから下胸部まで導かれます。
