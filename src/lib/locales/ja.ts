...
アニメーションはワークアウトの実際のレートに同期します。記録された 1 ストロークごとに 1 漕ぎ（ポールプラントやペダル 1 回転）が再現され、キャッチのたびに水しぶきや雪煙が上がり、再生速度に合わせて速くなります。3D では、アスリートは胴体・頭・肩・腕・脚・手足を分けた人間スケールのモデルと競技別のウェアで描かれるため、玩具のマーカーではなくエルゴ上の選手として姿勢が読み取れます。チェイスカメラは身体の姿勢が見える距離を保ち、艇速が上がるとわずかに画角を広げます。
