...
まだ困っていますか？ [FAQ](/docs/faq) がさらにカバーしています。このガイドのすべてのページはヘッダーの**ヘルプ**から開けます。`,
  ...
  replay: {
    ...
    moments: {
      ...
      "efficient-rhythm": "Most efficient rhythm",
      "finish-trend": "Finish trend",
      "best-rep": "Best rep",
      "slowest-rep": "Slower rep",
      reasonBestSustained: "{delta}% quicker than today's baseline.",
      reasonSlowerPatch: "{delta}% below today's baseline; check rhythm and recovery here.",
      reasonEfficientRhythm: "Strong pace without needing your highest rate.",
      reasonFinishStronger: "Final third was {delta}% quicker than the first third.",
      reasonFinishFade: "Final third faded {delta}% versus the first third.",
      reasonFinishSteady: "Final third stayed within {delta}% of the first third.",
      reasonBestRep: "Rep {rep} was {delta}s/500m quicker than the set average.",
      reasonSlowestRep: "Rep {rep} was {delta}s/500m below the set average.",
    },
    lowRes: "低解像度リプレイ",
    compareAgainst: "比較対象:",
    none: "なし",
