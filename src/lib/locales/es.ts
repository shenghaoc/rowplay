...
La vista 2D sigue dibujando una figura atlética procedimental ligera. La vista 3D puede cargar un paquete compacto de geometría low-poly del atleta y del equipo, propiedad del repositorio y creado específicamente para rowplay, y adaptar esas formas diseñadas al mismo rig guiado por contactos. El movimiento y el tiempo siguen siendo ilustraciones deterministas impulsadas por los ciclos registrados, y manos y pies permanecen alineados con el equipo. Si el recurso local no se puede cargar, la figura 3D procedimental sigue disponible y 2D continúa como fallback externo estable. La figura es genérica: el recurso no contiene escaneos, resultados de generadores de avatares, imágenes del usuario ni la apariencia del atleta.
