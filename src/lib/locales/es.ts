...
Ambas vistas dibujan una figura atlética procedimental ligera en vez de descargar o escanear un avatar. Los segmentos superiores e inferiores de brazos y piernas conservan proporciones fijas y se articulan en codos y rodillas; el torso y la pelvis modelados, las articulaciones, la equipación y el contraste entre los lados cercano y lejano mantienen cada postura legible a la escala del replay. Las manos y los pies permanecen alineados con el equipo correspondiente durante todo el ciclo. Es una figura ilustrativa genérica: no reproduce el cuerpo, la ropa ni la apariencia del atleta.
