...
The 2D view draws a lightweight procedural athlete. The 3D view can load a compact, repository-owned low-poly athlete and sport-equipment geometry pack created for rowplay, then fit those authored shells to the same contact-driven rig. Motion and timing remain deterministic illustrations driven by logged cycles, and hands and feet remain aligned with equipment. If the local asset cannot load, procedural 3D remains available and 2D remains the stable outer fallback. The figure is generic: the asset contains no scan, avatar-generator output, user image, or athlete likeness.
