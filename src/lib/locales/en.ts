...
Both views draw a lightweight procedural athlete rather than downloading or scanning an avatar. Fixed-proportion upper and lower limbs bend at explicit elbows and knees, while shaped torsos, pelvises, joints, kit, and near/far-side contrast keep each pose readable at replay scale. Hands and feet remain aligned with the relevant equipment throughout the cycle. The figure is a generic illustration; it does not reproduce the athlete's body, clothing, or likeness.
