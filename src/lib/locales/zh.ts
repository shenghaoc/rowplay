export const zh = {
  ...
  landing: {
    ...
    feat3Title: "边缘加速",
    feat3Body: "由 Cloudflare 全球边缘网络提供服务——即时回放，无需等待。",
    tourEyebrow: "首次使用",
    tourTitle: "先试这四件事",
...
不会 — 你的仪表板和回放默认是私密的。你可以选择将成绩发布到排行榜或分享回放链接，但除非你主动选择，否则不会公开任何内容。
...
还是没解决？[常见问题](/docs/faq)涵盖更多内容，本指南的每一页都能从页眉的**帮助**进入。`,
  ...
  token: {
    ...
    trustAccessTitle: "访问：",
    trustAccessBody:
      "个人 Concept2 令牌代表你本人认证；rowplay 只用它读取资料、训练和逐桨数据。",
    trustStoredTitle: "存储：",
    trustStoredBody:
