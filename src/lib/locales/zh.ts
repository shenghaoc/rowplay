...
运动员动画与训练的真实桨频同步——每记录一桨，人物就划一桨（或撑一次杖、蹬一圈踏板），入水瞬间伴随水花或雪雾，并随回放速度一起加快。3D 中的人物改为更接近真人比例的分段身体，有躯干、头部、肩线、四肢、手脚和对应项目的运动装备，姿态读起来像正在使用测功仪的运动员，而不是玩具标记。赛道表面也会按项目变化：RowErg 有分层水道和浮标水线，SkiErg 有压过的雪道槽和蓝色门标，BikeErg 有沥青/赛车场质感、红白路缘、车道虚线和速度条。3D 追踪镜头也会保持更近的距离，让身体姿态看得见，并在艇速提高时轻微拉宽视野。
