...
describe('filterAndSortWorkouts', () => {
	const w2k = workout({ id: 1, distance: 2000, time: 480, sport: 'rower', date: '2026-05-01 06:00:00' });
	const w5k = workout({ id: 2, distance: 5000, time: 1200, sport: 'rower', date: '2026-04-01 06:00:00' });
	const wBike = workout({ id: 3, distance: 2000, time: 500, sport: 'bike', date: '2026-03-01 06:00:00' });
	...
	it('filters by date range', () => {
		const result = filterAndSortWorkouts(all, { ...base, dateFrom: '2026-04-01', dateTo: '2026-04-30' });
	...
	it('sorts by distance', () => {
		const result = filterAndSortWorkouts(all, { ...base, sort: 'distance', dir: 'asc', sport: 'rower' });
		expect(result[0].distance).toBeLessThanOrEqual(result[1].distance);
	});

	it('sorts by time', () => {
		const result = filterAndSortWorkouts(all, { ...base, sort: 'time', dir: 'asc', sport: 'rower' });
