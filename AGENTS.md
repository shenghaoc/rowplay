...
- [Replay premium environments](.kiro/specs/replay-premium-environments/tasks.md) — layered sport-specific 2D venue art and procedural 3D sky, horizon, ground, atmosphere, lighting, and scenery; venue composition remains local and illustrative, while provenance-recorded CC0 seamless surface maps may support High/Ultra materials (no generated/scanned venue imagery or imported venue models).
