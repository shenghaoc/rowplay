...
- [x] **2. RowErg steady fixture** — `tests/fixtures/golden/rower-steady.fixture.json`
...
- [x] **3. BikeErg steady fixture** — `tests/fixtures/golden/bike-steady.fixture.json`
...
- [x] **4. SkiErg steady fixture** — `tests/fixtures/golden/ski-steady.fixture.json`
