...
- [ ] **4. InspectorPanel component** — `src/lib/components/InspectorPanel.svelte`
...
- [ ] **5. Replay page wiring + toggle** — `replay/[id]/+page.svelte`
...
- [ ] **6. Metadata rows + public redaction** — InspectorPanel + shared view
...
- [ ] **8. E2E + full gate** — `tests/e2e/inspector.spec.ts`
