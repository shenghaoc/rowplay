...
3. THE function SHALL use the shared native Temporal helpers in
   `src/lib/datetime.ts` for timezone conversion, with no bundled polyfill or
   manual fixed-offset table.
