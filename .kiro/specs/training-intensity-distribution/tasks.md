...
- [x] **1. Pure training-zones core** — `src/lib/trainingZones.ts`
...
- [x] **2. Unit tests** — `src/lib/trainingZones.test.ts`
...
- [x] **3. Dashboard TID chart** — `src/routes/dashboard/+page.svelte`
...
- [x] **4. i18n keys** — `src/lib/locales/{en,zh,de,es,fr,ja}.ts`
