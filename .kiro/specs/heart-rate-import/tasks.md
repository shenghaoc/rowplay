...
- [ ] **1. Pure HR merge core** — `src/lib/hrImport.ts`
...
- [ ] **6. i18n** — `src/lib/i18n.ts` (en + zh)
  - All `replay.hrImport.*` keys from design.
  - _Requirements: 5.2_

- [ ] **7. E2E smoke + fixture** — `tests/fixtures/hr-watch.csv`,
  `tests/e2e/hr-import.spec.ts`
  - _Requirements: 5.3_

- [ ] **8. Full gate + HANDOFF** — run check/build/test/e2e; remove parking-lot
