...
- **Date_Intl_Time**: Strict `Date` parsing plus `Intl.DateTimeFormat` timezone helpers used by rowplay
...
| Date/time strategy | ✅ No bundled polyfill; Date/Intl helpers cover runtime targets |
| Security | ⚠️ No CSP |
