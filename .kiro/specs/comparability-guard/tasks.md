...
- [ ] **1. `durationBand` helper** — `src/lib/analytics.ts`
...
- [ ] **2. Comparability guard module** — `src/lib/replay/comparabilityGuard.ts`
...
- [ ] **3. Unit tests** — `src/lib/comparabilityGuard.test.ts`
...
- [ ] **4. Ghost picker guard** — `src/lib/replay/ghostPick.ts`
...
- [ ] **5. Replay page wiring** — `src/routes/replay/[id]/+page.svelte`
...
- [ ] **6. /compare hard block** — `src/routes/compare/+page.svelte`
