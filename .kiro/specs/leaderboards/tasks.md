...
- [ ] **1. Pure ranking core** — `src/lib/leaderboard.ts`
...
- [ ] **2. Unit tests for the core** — `src/lib/leaderboard.test.ts`
  - Snap/reject, rank order, tie handling, gap maths, board grouping/order.
  - _Requirements: 5.1_

- [ ] **3. Deterministic demo seed** — `src/lib/mockLeaderboard.ts`
