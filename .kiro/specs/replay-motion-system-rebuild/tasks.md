...
- [x] **9. Correct RowErg draw biomechanics in both renderers**
  - [x] Keep both arms softly long through the leg drive and body opening, with
    visible elbow flexion starting only after drive-side hand/knee clearance
    and near-complete leg extension
...
- [x] **13. Keep the Canvas SkiErg athlete grounded through the complete cycle**
  - [x] Keep the neutral pelvis inside a grounded standing-compression band and
    limit press compression without inventing a recovery jump
  - [x] Preserve torso length above the corrected pelvis instead of shortening
    the upper body
  - [x] Protect minimum and maximum pelvis height, vertical excursion, knee snow
    clearance, vertical thigh readability, exact segment length, and dense
    full-cycle continuity with browser acceptance
